		...
		<div class="page-content">
			<div class="container">
				...
				<div class="row margin-vert-30">
					<!-- Main Text -->
					<h1 class="black text-center">Success !</h1><br>
					<div class="col-md-9 col-sm-8 col-xs-12">
						<!--<h2>Nulla in enim quis</h2>-->

						
						<div class="well black">
							<h3>Thank You, Your Order has been sent successfully.</h3><br>
							<h3>Get back to the <a class="pink" href="index.php">Home</a> Page.</h3>
						</div>
